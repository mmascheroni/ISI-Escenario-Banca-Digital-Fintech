...
**Versión:** 1.0  
**Fecha:** Mayo 2026  
**Base:** 38 amenazas identificadas en `docs/03-analisis-stride.md`
...
| **Discoverability** | D      | ¿Qué tan fácil es descubrir la vulnerabilidad? | Muy difícil de encontrar                | Requiere análisis técnico           | Visible públicamente, documentada           |

**Fórmula:** `DREAD Score = (D + R + E + A + D) / 5` → Rango **0 a 10**
...
| ID   | Amenaza                                                 | Comp.      | D   | R   | E   | A   | D   | **Suma** | **Score /5** | **Nivel**  |
| ---- | ------------------------------------------------------- | ---------- | --- | --- | --- | --- | --- | -------- | ------------ | ---------- |
...
| TH02 | Manipulación de parámetros via MitM                     | App Móvil  | 8   | 5   | 5   | 7   | 4   | **29**   | **5.8**      | 🟡 MEDIO   |
...
| TH03 | Datos sensibles en logs del sistema operativo           | App Móvil  | 5   | 5   | 5   | 5   | 5   | **25**   | **5.0**      | 🟡 MEDIO   |
...
| **#22**   | TH01 | **6.2** | Robo de JWT en dispositivo móvil            |
| **#23**   | TH26 | **6.2** | Notificaciones push con datos sensibles     |
| **#24**   | TH23 | **6.0** | IDOR en portfolio de inversión              |
...
### #2 — TH08: Bypass JWT con `alg:none` (Score: 44/50)
...
| **TOTAL**            | **8.8 / 10** | **🔴 CRÍTICO — Remediar en < 24 horas**                                                                                                                            |

---

### #3 — TH09: Credential Stuffing sin Rate Limiting (Score: 42/50)
...
| **TOTAL**            | **8.4 / 10** | **🔴 CRÍTICO — Remediar en < 24 horas**                                                                                                                                    |
...
## 5.6 Supuestos del Análisis DREAD
...
## 5.7 Ajuste Regulatorio — Impacto BCU en el Criterio Damage (D)
